-- Проверка проблемы с FEES_TOTAL
SET PAGESIZE 1000
SET LINESIZE 200

PROMPT ========================================
PROMPT Проверка данных в представлении для конкретной записи
PROMPT ========================================
SELECT 
    BILL_MONTH,
    IMEI,
...
SELECT 
    ...
    fee_prorated,
    fees_total,
    fee_activation_fee + fee_advance_charge + fee_credit + fee_credited + fee_prorated AS calculated_total
FROM steccom_fees
