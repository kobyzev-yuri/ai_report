...
/
COMMENT ON COLUMN V_REVENUE_FROM_INVOICES.SERVICE_START_DATE IS 'START_DATE из V_IRIDIUM_SERVICES_INFO (справочно по клиенту); признание разового подключения в доходах — по OPEN_DATE (см. REVENUE_CONNECTION_RUB)'
/
