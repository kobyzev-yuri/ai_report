...
echo "   - Basic Package (instantclient-basic-linux.x64-21.1.0.0.0.zip)"
echo "   - SQL*Plus Package (instantclient-sqlplus-linux.x64-21.1.0.0.0.zip)"
echo ""
...
echo ""
echo "   cd $INSTALL_DIR"
echo "   sudo unzip instantclient-basic-linux.x64-21.1.0.0.0.zip"
echo "   sudo unzip instantclient-sqlplus-linux.x64-21.1.0.0.0.zip"
echo "   cd instantclient_21_1"
echo "   sudo ln -sf libclntsh.so.21.1 libclntsh.so"
echo ""
echo "5. Настройте переменные окружения:"
echo ""
echo "   echo 'export ORACLE_HOME=$INSTALL_DIR/instantclient_21_1' >> /etc/profile.d/oracle.sh"
